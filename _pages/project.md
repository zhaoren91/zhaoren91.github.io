...
# Silent Paralinguistics (funded by DFG)
*Runtime*: 2024 - 2027

*Abstract*: As the state-of-the-art speech synthesis from Electromyography (EMG) signals lack of paralinguistic information, this project aims to detect paralinguistics from EMG and integrate the detected information into EMG-to-Speech conversion models.

<a href="" target="_blank"></a>
# MyVoice: Myoelectric Vocal Interaction and Communication Engine (funded by DFG)
*Runtime*: 2022 - 2025
*Abstract*: The goal is to synthesise speech from surface Electromyography (EMG) signals, thereby helping patients who cannot produce acoustic speech. 
